...
module.exports = {
    ...
    index(req, res) {
        Country.findAll({
                attributes: ['id', 'name', 'continent', 'continent_id', 'description', 'latitude', 'isvisible', 'longitude', 'createdAt', 'updatedAt', 'elevation'],
                order: [
                    ['createdAt', 'DESC']
                ]
            })
        ...
        Location.findAll({
                ...
                include: [{
                    ...
                    include: [{
                        ...
                        attributes: ['id', 'city', 'state', 'country', 'continent', 'latitude', 'longitude', 'elevation', 'country_id']
                    }]
                }]
            })
            .then(function(authors) {
