...
module.exports = {
    ...
    index(req, res) {
        console.log('Image index request====>');
        console.log(req.body);
        console.log(req.body.tourids.length);

        console.log('images get req, index====>');
        if (req.body.tourids && req.body.tourids[0] !== null) {
            console.log('Part1=====>');
            Image.findAll({
                    attributes: ['id', 'filename', 'parentobjectname', 'parentobjectid'],
                    order: [
                        ['createdAt', 'DESC']
                    ],
                    where: {
    ...
    indexAll(req, res) {
        console.log('images get req, indexAll====>');
        console.log(req.body);
        Image.findAll({
                order: [
                    ['createdAt', 'DESC']
    ...
    create(req, res) {
        ...
        req.files.forEach(function(file) {
            ...
            imageRec.path = path.resolve('../public/images', file.filename + '.webp');
    ...
    delete(req, res) {
        ...
        Image.findByPk(queryVars.id, {}).then((result) => {
            ...
            Image.destroy({
                ...
                const jsonPath = path.resolve(result.path);
