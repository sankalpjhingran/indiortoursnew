...
$scope.initGrid = function(gridOptions, tourtype) {
    ...
    gridOptions.columnDefs = [
      ...
      {
        name: 'costcategory', visible: false
      },
      {
        name: 'costitem', displayName: 'Cost Category',
        width: 300, enableCellEdit: false
      },
...
$scope.createUpdatecosts = function() {
  ...
  if($scope.tour) {
      ...
      console.log(costsToUpdate);
      console.log(costsToCreate);
